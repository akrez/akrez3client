...
$this->title = Api::getBlogAttribute('title') . ' | ' . $dp['product']['title'];
...
Breadcrumbs::widget([
    ...
    'links' => [
        ['label' => $dp['categories'][$dp['categoryId']], 'url' => Api::url('site', 'category', ['id' => $dp['categoryId']])],
        ['label' => $dp['product']['title']],
    ],
]);
?>
...
<div class="row">
    <div class="col-sm-12 pb20">
        <h1 class="mt0"><?= HtmlPurifier::process($dp['product']['title']) ?></h1>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-sm-5 pb20">
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <?php
                $i = 0;
                foreach ($dp['images'] as $imageKey => $image):
                    echo '<div class="' . ($i == 0 ? 'item active' : 'item') . '"> <img src="' . Api::galleryUrl($image['name'], 'product', '400') . '" class=""> </div>';
                    $i++;
                endforeach;
                ?>
            </div>
    ...
    <div class="col-sm-7 pb20">
        <div class="container-fluid">
            <div class="row equal">
                <?php foreach ($dp['packages'] as $package): ?>
                    <a class="thumbnail col-xs-12 col-sm-12 col-md-6" href="<?= Api::url('site', 'basket-add', ['id' => $package['id']]) ?>">
                        <div class="caption">
                            ...
                            <div>
                                ...
                                <span style="float: left;">
                                    <?= HtmlPurifier::process(Helper::formatPrice($package['price'])) ?>
                                </span>
...
<div class="row pb20">
    <div class="col-sm-12">
        <table class="table table-striped table-bordered">
            <tbody>
                <?php foreach ($dp['productFields'] as $productField): ?>
                    <tr>
                        <td>
